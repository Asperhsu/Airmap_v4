					...
					<li class="list-group-item" data-name="siteLayer" >
						...
						<div class="list-group-item-text" v-show="showItemText('siteLayer')" transition="slide">
							...
							<div class="blockquote-content site-icon-text">
								...
								<div>
									<svg width="30" height="30" viewBox="-94 -94 680 680" xmlns="http://www.w3.org/2000/svg" >
										<path stroke="#FFFFFF" stroke-width="10" fill="#333333" d="M499.669,495.616C406.528,348.416,373.333,159.595,373.333,32c0-28.885-85.781-32-122.667-32C213.781,0,128,3.115,128,32
