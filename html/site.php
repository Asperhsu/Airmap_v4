...
<html lang="">
	<head>
		...
		<meta property="og:url" content="https://airmap.g0v.asper.tw/site">
	...
	<body data-spy="scroll" data-target="#sidebar" data-offset="30">
		...
		<div id="error-msg" class="container block-msg">
			...
			<h3 class='msg'></h3>
			<h4>You can try alternate site: <span id="alternateSite"></span></h4>
			<h5>Or You can copy page url and send to asperwon+airmap@gmail.com.</h5>
		</div>
