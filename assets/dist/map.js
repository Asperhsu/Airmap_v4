...
/***/ function(module, exports, __webpack_require__) {
	...
	$input.typeahead({
		...
		fitToElement: true,
		minLength: 3,
		highlighter: function highlighter(displayText, item) {
			var iconClass = "";
			if (item.instance) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".bs-switch.siteVoronoi").on('switchChange.bootstrapSwitch', function (event, state) {
		...
		if (!siteVoronoiLayer) {
			var siteTool = __webpack_require__(23);
			var VoronoiLayer = __webpack_require__(62);
	...
	$(".bs-switch.emissionSites").on('switchChange.bootstrapSwitch', function (event, state) {
		var EmissionLayer = __webpack_require__(66);
		if (state) {
	...
	$(".bs-switch.satelliteLayer").on('switchChange.bootstrapSwitch', function (event, state) {
		...
		if (!satelliteLayer) {
			...
			var SatelliteLayer = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.boot = function () {
		...
		var locations = [];
		var emissionData = __webpack_require__(67);
		var image = {
