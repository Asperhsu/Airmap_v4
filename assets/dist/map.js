...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSource = __webpack_require__(23);
	var siteTool = __webpack_require__(24);
	...
	if (isIE || isEdge) {
		...
		$("body").on('dataSourceLoadSources', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Site = __webpack_require__(25);
	...
	function setGroupCount(Site) {
		...
		if (!groupCount[siteGroup]) {
			groupCount[siteGroup] = 0;
		}
	...
	function setAnalysisCount(Site) {
		...
		if (status.indexOf('shortterm') > -1) {
			status = 'shortterm';
		}
		if (status.indexOf('longterm') > -1) {
			status = 'longterm';
		}
	
		if (!analysisCount[status]) {
			analysisCount[status] = 0;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Site;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(16), __webpack_require__(5)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapHandler = __webpack_require__(16);
