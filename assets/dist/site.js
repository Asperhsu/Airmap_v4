...
/***/ function(module, exports, __webpack_require__) {
	...
	var SiteHistoryChart = __webpack_require__(49);
	var siteHelper = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	InfoWindowLayer.prototype.onAdd = function () {
		var html = ['<div id="' + this.containerID + '" >', '<div class="arrow"></div>', '<div class="iw-header">', '<div class="ranking" title=":ranking"></div>', '<div class="update-at">Updated <span class="time"></span> ago.</div>', '</div>', '<div class="iw-content">', '<div class="main-garge garge-background"></div>', '<div class="sub-garge">', '<div class="sub-garge-top garge-background"></div>', '<div class="sub-garge-bottom garge-background"></div>', '</div>', '</div>', '<div class="iw-footer">', '<div class="iw-name"></div>', '<div class="iw-link">', '<a class="line-chart" title=":historyChart">', '<span class="glyphicon glyphicon-stats"></span>', '</a>', '<a href="" target="_blank" class="indep-page" title=":independentPage">', '<span class="glyphicon glyphicon-bookmark"></span>', '</a>', '</div>', '</div>', '</div>'].join('').replace(':ranking', LANG.get('ranking')).replace(':historyChart', LANG.get('historyChart')).replace(':comment', LANG.get('siteComment')).replace(':independentPage', LANG.get('independentPage'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LANG = {
		...
		translateApp: function translateApp() {
